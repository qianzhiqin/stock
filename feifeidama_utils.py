...
def TestFunc():
    pd_id = "115849"  # 用户中心页可以查询到pd信息
    pd_key = "MxCq+V+84bwXbmVq7RqoOzBkW1cw799X"
    app_id = "315849"  # 开发者分成用的账号，在开发者中心可以查询到
    app_key = "G7mbhH7HfySKoyvYnzfv5r0STEhK2kk7"
    # 识别类型，
...
if __name__ == "__main__":
    code = rec_vcode_file("d:\\captcha-image.jpg")
    print(code)
